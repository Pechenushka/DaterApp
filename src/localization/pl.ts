...
const pl: localizationPackType = {
  ...
  dear_users: 'Drodzy użytkownicy!',
  support_text:
    'Aby nadal być bezpłatną aplikacją, potrzebujemy Twojego wsparcia. Nie ograniczamy Twojego korzystania z aplikacji. Wesprzyj nas na Patreonie',
